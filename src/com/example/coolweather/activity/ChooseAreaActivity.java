...
public class ChooseAreaActivity extends Activity {
	...
	private void queryProvinces() {
		provinceList = coolWeatherDB.getAllProvince();
	...
	private void queryCities() {
		cityList = coolWeatherDB.getCityByProvinceId(selectedProvince.getId());
		if(cityList.size() > 0) {
			dataList.clear();
			...
			adapter.notifyDataSetChanged();
			listView.setSelection(0);//默认指向第一位置
	...
	private void queryCounties() {
		countyList = coolWeatherDB.getAllCountyByCityId(selectedCity.getId());
